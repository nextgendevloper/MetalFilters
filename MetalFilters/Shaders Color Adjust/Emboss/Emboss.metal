...
kernel void emposs(texture2d<half, access::write> outputTexture [[texture(0)]],
                                 texture2d<half, access::sample> inputTexture [[texture(1)]],
                                 constant float *convolution [[buffer(0)]],
    ...
    const float3x3 convolutionMatrix = float3x3(float3(*convolution * -2, -*convolution, 0),
                                        float3(-*convolution, 1, *convolution),
                                        float3(0, *convolution, *convolution * 2));
